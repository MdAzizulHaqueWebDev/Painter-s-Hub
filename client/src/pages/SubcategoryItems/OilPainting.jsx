...
const OilPainting = () => {
	...
	const [oilPainting, setOilPainting] = useState(null);
	useEffect(() => {
		fetch("https://assign-ment-10-server-side.vercel.app/oil-painting")
			.then((res) => res.json())
			.then((data) => {
				setOilPainting(data);
				setLoader(false);
	...
	return (
		<>
			...
			<div className="text-center my-6 playfair">
				<h2 className="text-3xl font-bold "> Oil Painting Arts And Crafts</h2>
			</div>
			<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
				{oilPainting?.map((data) => (
